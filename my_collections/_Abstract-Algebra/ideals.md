...
- [Theorem (well-defined multi.)](#theorem-well-defined-multi)
  ...
  - [Examples](#examples)
- [Theorem (principal ideal)](#theorem-principal-ideal)
  - [Corollary (eq. propertiey)](#corollary-eq-propertiey)
...
- [Theorem (kernel ideal tongue twister)](#theorem-kernel-ideal-tongue-twister)
  - [Remark](#remark)
- [Theorem (operations on ideals)](#theorem-operations-on-ideals)
- [Remark](#remark-1)
...
> 小心！$$Ra$$ **不一定**包含 $$a$$，因為 $$1_R$$ 不一定存在（沒有 unity）。
