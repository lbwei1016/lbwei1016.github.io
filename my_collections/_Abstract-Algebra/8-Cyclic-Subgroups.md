...
### Definition (order)
> If $$\langle a \rangle$$ has a finite number of element, then the **order of $$a$$** is the order \|$$\langle a \rangle$$\| of this subgroup; otherwise, we say $$a$$ is of **infinite order**.
